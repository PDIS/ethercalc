...
// But modified manually since I don't know a piece of LiveScript
(function(){
  var join$ = [].join;
  this.include = function(){
        ...
        '/_hackfoldr': function(){
            ...
            if (KEY) {
                if ((ref1$ = this.query.auth) != null && ref1$.length) {
                    return sendFile('hackfoldr/index.html').call(this);
                } else {
    ...
    this.get({
      '/:room': function(){
        ...
        if (!/modify/.test(this.request.get('x-sandstorm-permissions')) && !((ref$ = this.query.auth) != null && ref$.length)) {
          return this.response.redirect(BASEPATH + "/sheet1?auth=0");
        }
        if (KEY) {
          if ((ref1$ = this.query.auth) != null && ref1$.length) {
